...
def create_release(source):
    release_name = _get_cpp_define_value(env, "WIZMOTE_RELEASE_NAME")
    if release_name:
        version = _get_cpp_define_value(env, "WIZMOTE_VERSION")
        release_file = os.path.join(OUTPUT_DIR, "release", f"WIZMOTE_{version}_{release_name}.bin")
